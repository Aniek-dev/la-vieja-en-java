...
public class FormLaVieja extends javax.swing.JFrame {
    ...
    public FormLaVieja(Jugador jugador1,Jugador jugador2) {
...
tablero.setMargen(5);
tablero.setColorCI(new Color(10,10,50));
tablero.setColorTablero(new Color(20,45,60));
...
panelFondo.add(tablero);
    ...
    private void initComponents() {
        ...
        jugadorCirculo.setBounds(280, 50, 50, 50);

        jugadorEquis.setText("imagen1");
        jugadorEquis.setRuta("/resources/JugadorEquis.png");
        panelFondo.add(jugadorEquis);
        jugadorEquis.setBounds(80, 50, 50, 50);

        lblNombreJ2.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        ...
        lblNombreJ2.setVerifyInputWhenFocusTarget(false);
        panelFondo.add(lblNombreJ2);
        lblNombreJ2.setBounds(260, 110, 90, 30);

        lblNombreJ1.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        ...
        lblNombreJ1.setVerifyInputWhenFocusTarget(false);
        panelFondo.add(lblNombreJ1);
        lblNombreJ1.setBounds(60, 110, 90, 30);
        ...
        lblPuntajeJ2.setVerifyInputWhenFocusTarget(false);
        ...
        jLabel3.setBounds(190, 50, 20, 60);
