...
public class Tablero extends JPanel {
        ...
        MouseListener evento = new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if(jugadorActual ==  TipoImagen.EQUIS){
                 ...
                 tipoImagenResultado = jugador1.LaVieja(jugador2);
                ...
                tipoImagenResultado = jugador2.LaVieja(jugador1);
    ...
    FormLaVieja.imgJugadorEquis.setRuta(Ruta.JUGADORAUXILIAR);
    FormLaVieja.imgJugadorEquis.repaint();
    FormLaVieja.nombreJugadorEquis.setForeground(new Color(240,240,240,100));
    
    FormLaVieja.imgJugadorCirculo.setRuta(Ruta.JUGADORCIRCULO);
    FormLaVieja.imgJugadorCirculo.repaint();
    FormLaVieja.nombreJugadorCirculo.setForeground(new Color(255,200,255));
    }else if(jugadorAct==TipoImagen.EQUIS){
    FormLaVieja.imgJugadorCirculo.setRuta(Ruta.JUGADORAUXILIAR);
    FormLaVieja.imgJugadorCirculo.repaint();
    FormLaVieja.nombreJugadorCirculo.setForeground(new Color(240,240,240,100));
    
    FormLaVieja.imgJugadorEquis.setRuta(Ruta.JUGADOREQUIS);
    FormLaVieja.imgJugadorEquis.repaint();
    FormLaVieja.nombreJugadorEquis.setForeground(new Color(180,232,255));
  
    }
    }
   public void resultado(TipoImagen tipoImagenResultado,TipoImagen jugadorGanador) {
       
    if (tipoImagenResultado == null) {
    System.out.println("Aún no hay ganador");
} else if (tipoImagenResultado == TipoImagen.EMPATE) {
...
timer.schedule(tarea,800);
   ...
   int puntajeNuevo= Integer.parseInt(FormLaVieja.puntajeEquis.getText())+1;
   FormLaVieja.puntajeEquis.setText(String.valueOf(puntajeNuevo));
   }
   else if (ganador==TipoImagen.CIRCULO){
   int puntajeNuevo= Integer.parseInt(FormLaVieja.puntajeCirculo.getText())+1;
   FormLaVieja.puntajeCirculo.setText(String.valueOf(puntajeNuevo));
   }
