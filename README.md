...
👉 [Descargar aquí lavieja.exe](https://github.com/Aniek-dev/la-vieja-en-java/releases/download/v1.0.0/Juego.de.la.Vieja-1.0.exe)


*(Haz clic arriba, descarga el archivo `.exe`, y ejecútalo para instalar el juego).*
